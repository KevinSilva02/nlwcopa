    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center' >
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          ...
          <strong className='text-gray-100 text-xl' ><span className='text-ignite-500' >+{props.usersCount}</span> pessoas ja estão usando</strong>
        </div>
        ...
        <div className='mt-10 pt-10 border-t border-gray-600 flex items-center justify-between text-green-100'>
...
export const getServerSideProps = async ()=> {
  const [poolCountResponse, guesseCountResponse, usersCountResponse] = await Promise.all([
    api.get('pools/count'),
